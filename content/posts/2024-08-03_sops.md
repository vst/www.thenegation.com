...
not at all in certain environments.
...
[opsops] is a tool that I wrote to generate the clear secrets file in a
declarative way. It is agnostic to what you use it for: It can be used to deploy
secrets to NixOS or somewhere else.
...
I am planning to add new types of sources in the future.
